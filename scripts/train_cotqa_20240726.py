...
out_dir = "results/ballmer_20240726"
num_epochs = 40
...
for train_dataset, validation_dataset in traj_train_traj_validation:
    for lr in lrs:
        for r in rs:
            ...
            data_gen_func_call = f"python3 train_loop.py --num_epochs {num_epochs} --batch_size {batch_size} --learning_rate {lr} --data_path {train_dataset} --val_path {validation_dataset} --out_dir {out_dir}"
